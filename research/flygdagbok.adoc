...
_21/4_: Till {f7} igen.
Löjtnant Rosén erbjuder mig utan vidare att
få bo i kadettförläggningen.
Förra gången gick det minsann inte att ordna trots att löjtnant Jakobsson tidigare lovat det (lag i en skollokal tillsammans med en massa bassar).
