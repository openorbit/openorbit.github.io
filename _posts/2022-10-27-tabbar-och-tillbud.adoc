...
| 2023-10-14 | Lade till opublicerad sektion: <<_effektförlust_under_start>>
| 2023-10-14 | Lade till opublicerad sektion: <<_örnjakt_med_flyg>>
|===
...
I detta fall https://sv.wikipedia.org/wiki/Klemm_Kl_35[Sk 15 (Klemm)].
...
efter utmagringen med 8 https://en.wikipedia.org/wiki/Mean_effective_pressure[BMEP (Brake Mean Effective Pressure)].
