...
NOTE: Det misstänktes att detta var kraschen som var https://aviation-safety.net/wikibase/271677[dokumenterad här] cite:[as:271677].
  Denna satte dock platsen till Reslöv istället för {Kvidinge}.
  Dock, efter att ha läst haverirapporten,
  kan man dock dra slutsatsen att haveriet dokumenterat i cite:[as:271677] är ett annat haveri än det som beskrivs i denna berättelse.
