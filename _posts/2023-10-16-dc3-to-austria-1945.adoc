...
:MiG-9: https://en.wikipedia.org/wiki/Mikoyan-Gurevich_MiG-9[MiG-9]
...
Probably a case of faulty labeling in the article. A footnote indicates the aircraft was called I-210 which is also known as {MiG-9}, and this aircraft fits the description.]
