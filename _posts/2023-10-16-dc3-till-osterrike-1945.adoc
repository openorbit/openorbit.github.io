...
:MiG-9: https://sv.wikipedia.org/wiki/Mikojan-Gurevitj_MiG-9[MiG-9]
...
och det dröjde inte alls länge förr än två rotar {MiG-5}
footnote:[Bara två prototyper av {MiG-5} byggdes, så två rotar kan omöjligen ha mötts.
Förmodligen är detta en fråga om felaktig benämning. En fotnot i SFF, indikerar att det var en I-210 som egentligen är en {MiG-9}. {MiG-9} passar beskrivningen.]
