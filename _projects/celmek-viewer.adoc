...
:page-project-github-latest: https://github.com/lorrden/CelMek-Viewer/releases/download/latest/CelMek-Viewer.zip
...
{page-project-github-latest}[CelMek Viewer.app]
